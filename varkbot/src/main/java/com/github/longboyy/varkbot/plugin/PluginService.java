...
public class PluginService {
	...
	private ServiceLoader<VarkBotPlugin> loader;
	...
	public synchronized List<VarkBotPlugin> getAvailablePlugins() {
		List<VarkBotPlugin> plugins = new LinkedList<VarkBotPlugin>();
		Iterator<VarkBotPlugin> iter = loader.iterator();
	...
	public synchronized void reloadJars() {
		this.loader = ServiceLoader.load(VarkBotPlugin.class, classLoader);
	}
}
